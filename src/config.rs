...
//! blob (`chronology_config`) + a per-repo JSON override. Scalar fields merge
//! per-field; repo wins.
//!
//! The resolver takes a `ConfigSource` trait so callers can supply JSON from any
//! storage backend without this crate depending on it.
